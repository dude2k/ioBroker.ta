...
const GROUP_DEFINITIONS = [
  ...
  { id: "system_general", name: "System general", patterns: [/^sg\d*$/i, /^system(?:_| |-)general/i] },
  { id: "system_date", name: "System date", patterns: [/^sd\d*$/i, /^system(?:_| |-)date/i] },
  { id: "system_time", name: "System time", patterns: [/^st\d*$/i, /^system(?:_| |-)time/i] },
  { id: "system_sun", name: "System sun", patterns: [/^ss\d*$/i, /^system(?:_| |-)sun/i] },
